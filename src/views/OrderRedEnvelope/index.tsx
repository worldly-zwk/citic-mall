...
import { OrderRedEnvelopeScreenProps } from '@/typings';

const OrderRedEnvelope = ({ navigation }: OrderRedEnvelopeScreenProps) => {
  const items = useOrder(state => state.order?.couponVOS || []);
...
export default OrderRedEnvelope;
